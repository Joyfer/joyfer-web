  ...
  <div class="Proyecto mt-16 fadeInDown">
    <v-container>
      ...
      <v-row>
        ...
        ><p class="text-caption mt-2"><v-icon left>mdi-fullscreen</v-icon>Clic en la imagen para ver pantalla completa</p></v-col>
        <v-col cols="12" md="5" class="fadeIn second"
          ...
          <BotonesProyectoVista class="mb-4" :url="filtrado[0].url" :gitRepo="filtrado[0].gitRepo"></BotonesProyectoVista>
